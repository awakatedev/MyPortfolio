    ...
    <>
      <section className="about">
        ...
        <p>
          ...
          constantly learning, and ambitious to build the best quality software,
          I'm also something of a crypto enthusiast and awakates lover!
        </p>
        <h2>Experience</h2>
        <p>
          ...
          contribute to the world of technology and offer software solutions to
          our customers.
        </p>
        <h2>Specialities</h2>
        <ul></ul>
        ...
        <p>
          ...
          related to things like UI and UX and providing an efficient experience
          within platforms. I'm very interested in data management, the
          automation of processes and the innovation like the offered by
